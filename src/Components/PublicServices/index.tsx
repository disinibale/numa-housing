        ...
        <>
            <div
                ...
                <div className='absolute inset-0 h-full w-full flex flex-row justify-between items-center'>
                    <div className='text-4xl px-10 hover:pl-12 h-full transition-all ease-in-out duration-300 bg-gradient-to-r opacity-50 hover:opacity-70 from-gray-700'>
                        <button
                    ...
                    <div className='text-4xl px-10 hover:pr-12 h-full transition-all ease-in-out duration-300 bg-gradient-to-l opacity-50 hover:opacity-70 from-gray-700'>
                        <button
